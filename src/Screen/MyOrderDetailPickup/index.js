...
export default function MyOrderDetailPickup() {
  ...
  const renderCardItem = ({item, index}) => (
    <AppCard
      ...
      isShowShadow={true}
      flexDirection={'row'}
      marginBottom={index === itemData.length - 1 ? 10 : 0}
      marginTop={10}>
    ...
    <Layout paddingHorizontal={0}>
      <ScrollView
        ...
        <View style={styles.besideSwipeContent}>
          ...
          <View style={[styles.rowContainer, {marginTop: 10}]}>
            <AppText style={styles.mainLabel}>Status</AppText>
            <AppText style={[styles.mainLabel, {color: Color.GOLD}]}>
              Delivered
            </AppText>
          </View>
          <FlatList
